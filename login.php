...
<head>
    ...
    <title>Login - Keuangan Kos</title>
    ...
    <div class="w-full max-w-sm px-6">
        ...
        <div class="glass-card rounded-2xl p-8 w-full">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-2xl font-semibold text-white tracking-tight">Selamat Datang</h2>
                <p class="text-xs text-slate-400 mt-2">Login untuk mengelola keuanganmu.</p>
            </div>
            ...
            <div class="mt-8 pt-6 border-t border-white/5 text-center">
                <p class="text-xs text-slate-500">
                    Belum punya akun? 
                    <a href="register.php" class="text-cyan-400 hover:text-cyan-300 font-medium transition ml-1 hover:underline">Daftar Akun</a>
                </p>
            </div>
